...
const MastercardDisabledIcon = (props: IconBaseProps) => {
  ...
  return (
    <svg
      className={classes}
      data-testid="MastercardDisabledIcon"
      viewBox="0 0 40 25"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M25.396 2.67383H14.5713V22.3259H25.396V2.67383Z" fill="#929292" />
      <path
...
MastercardDisabledIcon.defaultProps = {
  size: 'md',
  className: undefined,
  children: undefined,
  iconName: 'MastercardDisabled'
};

export default MastercardDisabledIcon;
